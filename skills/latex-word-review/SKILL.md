...
### 2. Archive and ingest the return
...
earlier object. Use fresh output paths for retries unless the CLI explicitly reports an identical
request as safely reusable.
